...
// GET - READ
let getAllRequest = () => {
    axios.get("http://localhost:8080/f1/getAll")
        .then((response) => {
...
let getByIdRequest = () => {
    axios.get("http://localhost:8080/f1/getById")
        .then((response) => {
            // console.log(response.data);
            displayResult(response.data);
        })
...
let getBySeasonRequest = () => {
    axios.get("http://localhost:8080/f1/getBySeason")
        .then((response) => {
            // console.log(response.data);
            displayResult(response.data);
        })
...
let getByWinnerRequest = () => {
    axios.get("http://localhost:8080/f1/getByWinner")
        .then((response) => {
            // console.log(response.data);
            displayResult(response.data);
        })
...
let getByNationRequest = () => {
    axios.get("http://localhost:8080/f1/getByNation")
        .then((response) => {
            // console.log(response.data);
            displayResult(response.data);
        })
...
let getByTeamRequest = () => {
    axios.get("http://localhost:8080/f1/getByTeam")
        .then((response) => {
            // console.log(response.data);
            displayResult(response.data);
        })
...
let postRequest = () => {
    ...
    axios.post("http://localhost:8080/f1/create", obj)
        .then((response) => {
...
// PUT/PATCH - UPDATE
let putRequest = () => {
axios.put("http://localhost:8080/f1/update", obj)
        .then((response) => {
            console.log(response);
            // displayResult(response.data.data);
        })
...
// DELETE - DELETE
let deleteRequest = () => {
    axios.delete("http://localhost:8080/f1/delete", obj)
            .then((response) => {
                console.log(response);
                // displayResult(response.data.data);
            })
